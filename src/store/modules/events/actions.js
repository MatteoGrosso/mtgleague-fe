...
export default {
  async addEvent(context, data) {
    ...
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events/new`,
      {
        method: 'POST',
        headers: {
  ...
  async loadEvents(context, payload) {
    ...
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events`
    );
  ...
  async subscribePlayerToEvent(context, payload) {
    ...
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events/${eventId}/register`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  async unSubscribePlayerToEvent(context, payload) {
    ...
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events/${eventId}/quit`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  async findEventById(context, payload) {
    const eventId= payload.eventId
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events/${eventId}`
    );
    const responseData = await response.json();
  ...
  async loadEventRanks(context, eventId){
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events/${eventId}/players`
    );
    const responseData = await response.json();
  ...
  async findCurrentRound(context) {
    ...
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/rounds/current`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  async confirmScore(context, payload){
    ...
    const token = context.rootGetters.getToken;
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/rounds/save`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  async startEvent(context, eventId){
    ...
    const response = await fetch(
      `http://http://ec2-35-174-170-51.compute-1.amazonaws.com:8080/events/${eventId}/start`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
